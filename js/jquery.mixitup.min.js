...
(function (e) {
  function m(d, b, h, c, a) {
    function j() {
      ...
      "list" == a.layoutMode ? (q.css({ display: a.targetDisplayList, opacity: "1" }), (a.origDisplay = a.targetDisplayList)) : (q.css({ display: a.targetDisplayGrid, opacity: "1" }), (a.origDisplay = a.targetDisplayGrid));
    ...
    if (q.filter(":visible").length == d && !t.length && !b) {
      ...
      if (1 == q.length)
        return "list" == a.layoutMode ? (c.addClass(a.listClass), c.removeClass(a.gridClass), l.css("display", a.targetDisplayList)) : (c.addClass(a.gridClass), c.removeClass(a.listClass), l.css("display", a.targetDisplayGrid)), j(), !1;
    }
  ...
  function v(d, b, h, c) {
    ...
    c.origSort.length ||
      f.find(c.targetSelector + ":visible").each(function () {
        e(this).wrap("<s/>");
    ...
    f.empty();
    if ("reset" == d)
      e.each(c.startOrder, function () {
        f.append(this).append(" \
	");
      });
    else if ("default" == d)
      e.each(c.origOrder, function () {
        j(this);
      });
    else if ("random" == d) {
	...
	");
      ...
      "custom" == d
        ...
        : ("undefined" === typeof c.origOrder[0].attr(d) && console.log("No such attribute found. Terminating"),
          c.newOrder.length ||
            (e.each(c.origOrder, function () {
    ...
    init: function (d) {
      return this.each(function () {
        ...
        setTimeout(function () {
          ...
          setTimeout(function () {
            "list" == b.layoutMode
              ? f.removeStyle(b.prefix + "transition, transition").css({ display: b.targetDisplayList, opacity: 1 })
        ...
        e(b.filterSelector).bind(b.buttonEvent, function () {
          if (!b.mixing) {
            var a = e(this);
            if (!1 == b.multiFilter)
              e(b.filterSelector).removeClass("active"), a.addClass("active"), (b.filter = a.attr("data-filter")), e(b.filterSelector + '[data-filter="' + b.filter + '"]').addClass("active"), "all" == b.filter && (b.filter = "mix_all");
            else {
